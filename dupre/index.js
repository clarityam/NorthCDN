...
const SEARCHES = [
  'who is charles dupre',
  'what is charles dupre',
  'when is charles dupre',
  'where is charles dupre',
  'why is charles dupre',
  'who is FBISD',
  'what is FBISD',
  'when is FBISD',
  'where is FBISD',
  'why is FBISD',
  'who is chris schooley',
  'what is chris schooley',
  'when is chris schooley',
  'where is chris schooley',
  'why is chris schooley'
]
...
const PHRASES = [
  ...
  'I like The lawnmower goes shersheeeeeeerrerererereeeerrr vavavoom sherererererere',
  'Dont you just hate it when your cat wakes you up like this? Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow. Meow.',
